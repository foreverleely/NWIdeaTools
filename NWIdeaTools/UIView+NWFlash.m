...
#import "UIView+NWFlash.h"
#import <objc/runtime.h>

static char NW_Flash_Layer0;
static char NW_Flash_Layer1;

@implementation UIView (NWFlash)
...
- (void)nw_addFlash:(CGSize)size
    ...
    objc_setAssociatedObject(self, &NW_Flash_Layer0, layer0, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    objc_setAssociatedObject(self, &NW_Flash_Layer1, layer1, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
...
- (void)nw_removeFlash {
    ...
    CALayer *layer0 = (CALayer *)objc_getAssociatedObject(self, &NW_Flash_Layer0);
    if (layer0) {
        
        [layer0 removeAllAnimations];
        [layer0 removeFromSuperlayer];
        objc_setAssociatedObject(self, &NW_Flash_Layer0, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
    CALayer *layer1 = (CALayer *)objc_getAssociatedObject(self, &NW_Flash_Layer1);
    if (layer1) {
        
        [layer1 removeAllAnimations];
        [layer1 removeFromSuperlayer];
        objc_setAssociatedObject(self, &NW_Flash_Layer1, nil, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
    }
